...
const Builder = {
    ...
    copyFilesToDestination: function (copyFilesArr,coFolderPath){
        ...
        includesContent.includes = includesContent.includes.filter(path => {
            ...
            return !((new RegExp(`^${Config.COMMON_FOLDER_NAME}`, 'i')).test(path));
        });

        // console.log(includesContent.includes);
        ...
        copyFilesArr.forEach(file => {
            ...
            const filePathRelative = path.relative(path.join(targetFolder, '..'), file);
        ...
        fs.writeFileSync(pathToIncludesFile, JSON.stringify(includesContent, null, 2));
